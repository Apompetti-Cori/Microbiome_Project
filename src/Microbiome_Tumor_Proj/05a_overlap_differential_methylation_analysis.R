...
contrast.matrix <- limma::makeContrasts(
  #contrast1a = consortium_by_suborgan - spf_by_suborgan,
  #contrast2a = consortium_by_suborgan - eckp_by_suborgan,
  #contrast3a = gf_by_suborgan - consortium_by_suborgan,
  #contrast4a = gf_by_suborgan - eckp_by_suborgan,
  #contrast5a = gf_by_suborgan - spf_by_suborgan,
  #contrast6a = eckp_by_suborgan - spf_by_suborgan,
  #contrast7a = gf_by_suborgan - (eckp_by_suborgan + spf_by_suborgan + consortium_by_suborgan),
  #contrast8a = by_suborgan - gf_by_suborgan,
  #contrast9a = by_suborgan - (gf_by_suborgan + consortium_by_suborgan + spf_by_suborgan + eckp_by_suborgan),
  contrast10a = (gf_by_suborgan + consortium_by_suborgan) - spf_by_suborgan,
  contrast1b = (gf_by_suborgan + consortium_by_suborgan) - eckp_by_suborgan,
